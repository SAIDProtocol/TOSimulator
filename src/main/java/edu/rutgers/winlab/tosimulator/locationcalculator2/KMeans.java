...
public class KMeans {
    ...
    public static class Builder {
        ...
        /**
         * Sets required parameters and checks that are a sufficient # of
         * distinct points to run KMeans.
         *
         * @param k
         * @param points
         */
     ...
     */
    /**
     * Uses either plusplus (KMeans++) or a basic randoms sample to choose
     * initial centroids
     */
    ...
    /**
     * Randomly chooses (without replacement) k data points as initial
     * centroids.
     */
     ...
     * using a weighted probability distribution (proportional to D(x)^2 where
     * D(x) is the distance from a data point to the nearest, already chosen
     * centroid).
     */
    ...
    private void plusplus() {
        ...
        for (int c = 0; c < k; c++) {
            ...
            System.arraycopy(points[choose], 0, centroids[c], 0, n);
        }
    }
    ...
    /**
     * Signals to stop running KMeans when the marginal improvement in WCSS from
     * the last step is small.
     *
     * @param prevWCSS error from previous step in the run
     * @return
     */
